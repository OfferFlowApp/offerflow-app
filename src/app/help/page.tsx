                ...
                <AccordionContent className="text-base pl-8 space-y-3">
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside space-y-1 pl-4">
                      ...
                      <li><DownloadIcon className="inline mr-1 h-4 w-4" /><strong>{t({ en: "Excel/CSV:", el: "Excel/CSV:" })}</strong> {t({ en: "Export product data for analysis (Business feature).", el: "Εξαγωγή δεδομένων προϊόντων για ανάλυση (λειτουργία Business)." })}</li>
                    </ul>
                  </div>
                   <div>
